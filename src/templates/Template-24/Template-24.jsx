...
const TemplateTwentyFour = ({ menuData }) => {
  ...
  return (
    <div className="min-h-screen bg-[#121113] text-white font-sans antialiased selection:bg-[#E63946] selection:text-white">
      <Header business={business} />
      <Hero business={business} />

      {/* Sticky Wooden Kifuda Nav */}
      <CategoryNav
      ...
      <section id="menu-root" className="max-w-5xl mx-auto px-4 sm:px-6 pt-2 pb-4">
        <div className="p-2 rounded-2xl bg-[#18161A] border border-white/10 flex flex-col sm:flex-row items-center gap-3">
          {/* Query Console */}
          <div className="relative w-full flex-1">
            ...
            <input
              type="text"
              placeholder="Search yakitori skewers, gyoza, ramen..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full pl-10 pr-4 py-2 bg-[#121113] rounded-xl text-xs sm:text-sm text-white placeholder-white/40 border border-white/10 focus:border-[#E63946] focus:outline-none transition-all font-mono"
            />
          </div>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 pt-4 pb-12">
        {filteredCategories.length > 0 ? (
          ...
          <div className="py-16 text-center text-white/50 font-mono text-xs uppercase">
